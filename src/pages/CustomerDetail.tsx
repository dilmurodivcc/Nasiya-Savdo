  ...
  if (error || !customer) {
    return (
      <div className="error-message">
        Xatolik yuz berdi: {(error as Error)?.message || "Mijoz topilmadi"}
      </div>
    );
  }
              ...
              <button className="star" onClick={() => toggleStar.mutate()}>
                ...
                >
                  <path
                    ...
                    fill={customer.is_starred ? "#FFA800" : "#00000040"}
                  />
                </svg>
              </button>
            </div>
              ...
              {(customer.debts || []).map((debt, index) => (
                <div key={index} className="debt-item">
                  ...
                  <div className="debt-footer">
                    <span>Keyingi to'lov: {debt.debt_status}</span>
                    <span>
