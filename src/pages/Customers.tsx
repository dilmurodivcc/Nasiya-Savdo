        ...
        <div className="container">
          ...
          <div className="customer-list">
            <div className="customer-item">
              <div className="left">
                <h5 className="name">Rahmatulloh Madraximov</h5>
                <h6 className="phone">+998991234567</h6>
              ...
              <button className="star" onClick={() => toggleStar("customer1")}>
                {starredCustomers["customer1"] ? (
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
            ...
            <div className="customer-item">
              ...
              <button className="star" onClick={() => toggleStar("customer2")}>
                {starredCustomers["customer2"] ? (
                  <svg
                    width="24"
                    height="24"
                    viewBox="0 0 24 24"
